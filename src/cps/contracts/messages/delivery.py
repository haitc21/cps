...
ALLOWED_ORIGINAL_ROUTING_KEYS = frozenset(
    {
        ...
        "openstack.identity.domain.disable",
        "openstack.identity.domain.delete",
        "openstack.identity.project.create",
        "openstack.identity.project.update",
        "openstack.identity.project.disable",
        "openstack.identity.project.delete",
        "openstack.identity.role.ensure",
        "openstack.identity.role.revoke",
        "openstack.identity.quota.read",
        "openstack.identity.quota.update",

...
ALLOWED_ORIGINAL_ROUTING_KEYS = frozenset(
    {
        ...
        "openstack.image.metadata.patch",
        "openstack.image.visibility.set",
        "openstack.image.protection.set",
        "openstack.image.member.grant",
        "openstack.image.member.revoke",
        ...
        "openstack.volume.attachment.attach",
        "openstack.volume.attachment.detach",
        ...
        "openstack.identity.project.update",
        "openstack.identity.project.delete",
        "openstack.identity.role.assignment.ensure",
        "openstack.identity.role.assignment.revoke",
        "openstack.identity.role.assignment.collect",
        "openstack.quota.collect",
        "openstack.quota.update",
        "openstack.network.create",
        "openstack.network.update",
        "openstack.network.delete",
        "openstack.subnet.create",
        "openstack.subnet.update",
        "openstack.subnet.delete",
        "openstack.router.create",
        "openstack.router.update",
        "openstack.router.delete",
        "openstack.router.interface.ensure",
        "openstack.router.interface.remove",
        "openstack.port.create",
        "openstack.port.update",
        "openstack.port.delete",
        "openstack.security.group.create",
        "openstack.security.group.update",
        "openstack.security.group.delete",
        "openstack.security.group.rule.create",
        "openstack.security.group.rule.delete",
        "openstack.floating.ip.allocate",
        "openstack.floating.ip.associate",
        "openstack.floating.ip.disassociate",
        "openstack.floating.ip.release",

...
|---|---:|---|---|---|
| CPS-1501 Project-owned volume inventory and API | 8 | CPS | OPS-1501 | Ready |
| CPS-1502 Volume create/update/extend/delete | 8 | CPS | OPS-1502 | Ready |
| CPS-1503 Volume attach/detach | 8 | CPS | OPS-1503 | Ready |
| CPS-1504 Storage vertical acceptance | 5 | CPS/OPS | OPS-1501..1503 | Ready |

## Task backlog

| Task | Deliverable | Depends on | Status |
|---|---|---|---|
| [CPS-1501](../tasks/sprint-15/CPS-1501-volume-inventory-api.md) | Typed project-owned volume inventory and query APIs | CPS-1202, CPS-1203 | Ready |
| [CPS-1502](../tasks/sprint-15/CPS-1502-volume-lifecycle.md) | Durable volume create/update/extend/delete | CPS-1501 | Ready |
| [CPS-1503](../tasks/sprint-15/CPS-1503-volume-attachment.md) | Replay-safe attach/detach relationships | CPS-1501, CPS-403 | Ready |
| [CPS-1504](../tasks/sprint-15/CPS-1504-storage-acceptance.md) | Restart/redelivery and real-cloud storage acceptance | CPS-1501..1503 | Ready |

...
| CPS-1702 Instance console access | 5 | CPS | OPS-1702 | Superseded — Active backlog: no |
...
| [CPS-1702](../tasks/sprint-17/CPS-1702-instance-console.md) | Ephemeral capability-gated console access | CPS-403, CPS-1203 | Superseded — Active backlog: no |
...
1. Supersede console access until a non-durable authenticated response
   architecture receives threat approval; approve curated-catalog policy.
...
5. Deliver network guardrails; do not place console bearer credentials on the
...
- No console URL/token path exists on the durable operation boundary.
...
|---|---|---|---|
| Console URL behaves like a bearer secret | CPS/OPS | Current task superseded; require a separately approved authenticated non-durable response architecture | Superseded |
...
- Console boundary: CPS-1702 superseded because the only CPS-to-OPS command
  path is durable; no bearer URL/token schema or handler was introduced.

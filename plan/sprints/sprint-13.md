...
**Status:** Done for approved CPS/OPS scope — 1201/1202/1204 complete; 1203
...
| [CPS-1203](../tasks/sprint-13/CPS-1203-resource-authorization-boundary.md) | Ownership resolver and fail-closed TMS authorization port/stub | CPS-1202 | Deferred — Active backlog: no |
...
|---|---|---|---|
| TMS has no internal authorization endpoint in the allowed scope | External/TMS | Keep a strict CPS outbound port, use stub only for test/local, fail closed in production | Deferred — excluded TMS scope |
